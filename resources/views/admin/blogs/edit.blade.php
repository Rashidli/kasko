                                    ...
                                    <div class="card-body">
                                        @foreach($blog->sliders as $slider)
                                            <div class="image-container mb-2" data-slider-id="{{ $slider->id }}">
                                                ...
                                                <a class="btn btn-danger btn-sm" href="{{ route('delete-slider-image', ['id' => $slider->id]) }}">Sil</a>
                                            </div>
                                        @endforeach
                                        <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="services[]" id="" multiple class="form-control js-example-basic-single">
                                                @foreach($services as $service)
                                                    <option value="{{$service->id}}" {{ $blog->services->contains($service->id) ? 'selected' : '' }}>{{$service->title}}</option>
                                                @endforeach
                                            </select>
                                            @if($errors->first('services'))
                                                <small class="form-text text-danger">{{ $errors->first('services') }}</small>
                                            @endif
                                        </div>
                                    </div>
                                </div>
