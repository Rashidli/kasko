                    ...
                    <div class="card-body">
                        <nav aria-label="breadcrumb" style="margin-bottom: 20px;">
                            <ol class="breadcrumb bg-light p-3 rounded">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('messages.index') }}">Siyahı</a></li>
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ $message->translate('az')?->title }}</li>
                            </ol>
                        </nav>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name="{{ $lang }}_title"
                                                       value="{{ $message->translate($lang)->title }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control"
                                                          name="{{ $lang }}_description">{{ $message->translate($lang)->description }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="is_active" class="form-control">
                                <option value="1" {{ $message->is_active == true ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ $message->is_active == false ? 'selected' : '' }}>Deactive</option>
                            </select>
                        </div>

                        <div class="row mb-3">
                            @foreach($message->schedules as $index => $schedule)
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        let scheduleIndex = {{ $message->schedules->count() }}; // start with the existing count
