...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <form action="{{ route('forms.form_fields.store', $form->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                            ...
                            @foreach(['az', 'en', 'ru'] as $lang)
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang }}" role="tabpanel" aria-labelledby="{{ $lang }}-tab">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="{{ $lang }}_placeholder" value="{{ old("{$lang}_placeholder") }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="{{ $lang }}_label" value="{{ old("{$lang}_label") }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="{{ $lang }}_options">{{ old("{$lang}_options") }}</textarea>
