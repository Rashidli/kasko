...
@section('description', $content->seo_description)
@section('keywords', $content->seo_keywords)
        ...
        <div class="information-inner">
            <div class="insurance_info">
                <div class="insurance_info_img">
                    <img src="{{asset('/')}}front/image/kasko-info.png" alt="info" title="info">
                </div>
                <div class="insurance_info_content">
                    {!! $content->description !!}
                </div>
                <a href="{{route('dynamic.page',$contact_page->slug)}}" class="now-order">{{$words['now_order']->translate(app()->getLocale())->title}}</a>
            ...
            <div class="useful_info_box">
                <button class="useful_info_btn" type="button">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_309_3985)">
                            <path d="M9 6L15 12L9 18" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </g>
                        <defs>
                ...
                <div class="useful_info_list">
                    @foreach($contents as $item)
                        <a href="{{route('dynamic.page',$item->slug)}}" class="useful_info_link {{ request()->is('dynamic.page/'.$content->slug) ? 'active' : '' }}">
                            {{$item->title}}
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @endforeach
                    <a href="{{route('dynamic.page',$faq_page->slug)}}" class="useful_info_link {{ request()->is('dynamic.page/'.$faq_page->slug) ? 'active' : '' }}">
                       {{$faq_page->title}}
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_309_3977)">
                                <path d="M9 6L15 12L9 18" stroke="#0A2056" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
