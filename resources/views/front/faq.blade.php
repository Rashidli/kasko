            ...
            <div class="useful_info_box">
                ...
                <div class="useful_info_list">
                    @foreach($contents as $content)
                        <a href="{{route('dynamic.page',$content->slug)}}" class="useful_info_link {{ request()->is($content->slug) ? 'active' : '' }}">
                            {{$content->title}}
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{route('dynamic.page',$faq_page->slug)}}" class="useful_info_link {{ request()->is($faq_page->slug) ? 'active' : '' }}">
                        {{$faq_page->title}}
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_309_3977)">
                                <path d="M9 6L15 12L9 18" stroke="#0A2056" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
