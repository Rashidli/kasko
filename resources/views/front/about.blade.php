                    ...
                    <div class="advantages-box">
                        <div class="advantages-box-inner">
                            <div class="advantage-icon">
                                <img src="{{ asset('storage/' . $advantage->image) }}" alt="{{ $advantage->img_alt }}"
                                    title="{{ $advantage->img_title }}">
                            </div>
            ...
            <div class="home-partners-items">
                @foreach ($partners as $partner)
                    <div class="partner-item">
                        <img src="{{ asset('storage/' . $partner->image) }}" alt="{{ $partner->img_alt }}"
                            title="{{ $partner->img_title }}">
                    </div>
                @endforeach
